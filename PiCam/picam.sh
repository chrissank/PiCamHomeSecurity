...
# udp://$FULLIP = output URL for the UDP stream
raspivid -t 0 -w 1920 -h 1080 -fps 30 -b 6000000 -ih -o - | tee $VIDEO_FILE | ffmpeg -thread_queue_size 4096 -i - -f lavfi -i anullsrc -c:v copy -f h264 udp://$FULLIP
